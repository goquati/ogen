...
import de.quati.ogen.oas.schemas.gen.model.BigDecimalDto
...
class ModelsKmpTest {
    ...
    fun `test UserDto`() {
        ...
        UserDto(
            ...
            height = BigDecimalDto(1.73),
            weight = BigDecimalDto(3.14),
            verified = true,
            locale = LocaleDto.DE,
            friends = listOf(
    ...
    fun `test Tenant with inner objects members`() {
        TenantDto(
            ...
            createdAt = Instant.fromEpochSeconds(123_456_789),
            parentId = null,
            name = null,
            members = listOf()
        ).test("""{"id":"af09a05a-aeb8-4d9a-b57b-2e1d578aedff","createdAt":"1973-11-29T21:33:09Z","parentId":null,"name":null,"members":[]}""")
        TenantDto(
            id = TenantIdDto(Uuid.parse("0aa3b372-3ae5-4e5c-92c0-9217be60d4cc")),
            createdAt = Instant.fromEpochSeconds(123_456_789 * 47),
            parentId = null,
            name = null,
            members = listOf(
        ...
        ).test("""{"id":"0aa3b372-3ae5-4e5c-92c0-9217be60d4cc","createdAt":"2017-10-08T22:29:47Z","parentId":null,"name":null,"members":[{"id":"0aa3b372-3ae5-4e5c-92c0-9217be60d4cc","name":"FooBar","email":"foo@bar.com","roles":["admin","member"]},{"id":"59ba3ff4-b2f7-456d-b80d-5149087c62f1","name":null,"email":"hello@world.com","roles":[]}]}""")
    }
