...
plugins {
    ...
    id("de.quati.ogen") version "0.9.1"

    implementation("de.quati.ogen:core:0.9.1")
    implementation("de.quati.ogen:client-ktor:0.9.1") // Optional: only for generate Ktor clients required
}
```
