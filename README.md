...
plugins {
    ...
    id("de.quati.ogen") version "0.10.0"

    implementation("de.quati.ogen:core:0.10.0")
    implementation("de.quati.ogen:client-ktor:0.10.0") // Optional: only for generate Ktor clients required
}
```
